...
fn specta_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        ...
        commands::work_order::list_trashed_work_orders,
        commands::work_order::trash_work_orders,
        commands::work_order::restore_work_orders,
        commands::work_order::permanently_delete_work_orders,
