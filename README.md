...
| 文件 | 说明 |
|------|------|
| `workOrder_1.1.9_x64-setup.exe` | NSIS 安装程序，推荐；会自动处理 WebView2 |
| `workOrder_1.1.9_x64_en-US.msi` | MSI 安装包 |
...
│   └── data/
└── installer/             # 安装包
    ├── workOrder_1.1.9_x64-setup.exe
    └── workOrder_1.1.9_x64_en-US.msi
```
